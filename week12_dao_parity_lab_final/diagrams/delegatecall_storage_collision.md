...
`delegatecall` executes library code **in the caller/proxy storage context**.  
Therefore, the library's state variable order must match the proxy's state variable order.

## Shared layout used in this lab
