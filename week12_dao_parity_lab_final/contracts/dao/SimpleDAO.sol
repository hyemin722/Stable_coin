...
contract SimpleDAO {
    ...
    function withdraw(uint256 amount) external {
        ...
        // Legacy DAO-style teaching model: old Solidity versions did not check arithmetic underflow.
        // This keeps the vulnerable replay executable on Solidity 0.8 while the fixed contracts keep checked arithmetic.
        unchecked {
